<?php
$token = "5333202088:AAHZFL0apli2xjGXY_ZwZZh9OBrwPujCPB4";
...
$add = json_encode([
"inline_keyboard"=>[
[["text"=>"🔥Поделиться с друзьями ","switch_inline_query"=>"hi"],],
]
]);
...
$ad1 = json_encode([
"inline_keyboard"=>[
[["text"=>"🔥 Добавить в группу","url"=>"https://t.me/savemaxbot?startgroup=new"],],
]
]);
...
🔎 | Бот - @savemaxbot",
    ...
    'reply_markup'=>[
     'inline_keyboard'=>[
     [['text'=>"😍 Скачать видео",'url'=>"https://t.me/savemaxbot?start="]]
     ]
     ]
     ],
])
...
🔰 | Hammasi bolib: $jami ta
✅ | Yuklangan videlar : $yuklangan ta
💻Dasturchi: @prostastory ",
'parse_mode'=>'html',
]);
}
